...
export async function getRootCategories() {
  // waitToCallApi()
  const res = await fetch(`${apiBase}/categories/roots/?language=${language}`);
...
export async function getAllCategories() {
  // waitToCallApi()
  const res = await fetch(`${apiBase}/categories/list/?language=${language}`);
  const info = await res.json();
  return info;
}
...
export async function getHadithsByCategory(id) {
  ...
  const res = await fetch(
    `${apiBase}/hadeeths/list/?language=${language}&category_id=${id}`
  );
  const info = await res.json();
  return info.data;
}
...
export async function getHadithDetailsById(id) {
  // waitToCallApi()
  const res = await fetch(`${apiBase}/hadeeths/one/?language=en&id=${id}`);
  const info = await res.json();
  return info;
}
