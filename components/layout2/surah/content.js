...
export default function ChapterContent({ contentType, contentTitle, chapters, chapterNo, chapterName, chapterSlug, chapterMp3Url, verses }) {
    ...
    const [prev, setPrev] = useState(
      contentType === "chapter" && chapters[chapterNo - 2]
        ...
        ? {
            link: `/chapters/${chapters[chapterNo - 1].slug}/verses/${Number(verses[0].verseNo) - 1}`,
            name: "Prev verse",
          }
    ...
    const [next, setNext] = useState(
      contentType === "chapter" && chapters[chapterNo]
        ...
        : contentType === "verse" && Number(verses[0].verseNo) == chapters[chapterNo - 1].totalVerse && chapterNo < chapters.length
        ?
          {
            ...
            <div className={styles.chapter}>
                ...
                <div className={styles.chapter_tab} ref={printRef}>
                    ...
                    <div className={styles.verses}>
                        ...
                        {/* {suraTranslation.result && suraTranslation.result.map((verse, index) =>
                            <VerseCard
                                key={verse.aya}
                                chapterName={chapterName}
                                index={index}
